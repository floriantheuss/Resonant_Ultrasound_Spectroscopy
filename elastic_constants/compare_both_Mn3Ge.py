...
# specify file paths
# Mn3Ge
Mn3Ge1 = 'C:\\Users\\Florian\\Box Sync\\Projects\\Mn3X\\Mn3Ge\\RUS\\Mn3Ge_2001B\\python fits\\Mn3Ge_out_elastic_constants.json'
Mn3Ge2 = 'C:\\Users\\Florian\\Box Sync\\Projects\\Mn3X\\Mn3Ge\\RUS\\Mn3Ge_2103B\\high_temperature_scan\\210329\\Mn3Ge_2103B_out_elastic_constants.json'
...
for i, irrep in enumerate(irreps):
    plt.figure()
    plt.title(irrep)
    plt.plot(T['Mn3Ge1'], dc_dict['Mn3Ge1'][irrep])

    dat = dc_dict['Mn3Ge2'][irrep]-c2[irrep]+c1[irrep]
    temp = T['Mn3Ge2']
    mask = temp > 370.45
    plt.plot(temp[mask], dat[mask])
